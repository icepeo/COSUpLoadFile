...
namespace COSUpLoadFile.Common
{
    public class XmlHelper
    {
        ...
        /// <returns></returns>
        public XmlNode GetXmlNode(string xmlFileName, string xPath)
        {
        ...
        /// <param name="xPath"></param>
        /// <returns></returns>
        public XmlNodeList GetXmlNodeList(string xmlFileName, string xPath)
        {
            XmlDocument xmldocument = new XmlDocument();
            //加载xml文档
            xmldocument.Load(xmlFileName);
        ...
        /// <returns></returns>
        public XmlAttribute GetXmlAttribute(string xmlFileName, string xPath, string attributeName)
        {
        ...
        /// <param name="xPath"></param>
        /// <returns></returns>
        public XmlAttributeCollection GetNodeAttributes(string xmlFileName, string xPath)
        {
        ...
        public bool UpdateAttribute(string xmlFileName, string xPath, string attributeName, string value)
        {
        ...
        /// <param name="xPath"></param>
        /// <returns>成功返回true,失败返回false</returns>
        public bool DeleteAttributes(string xmlFileName, string xPath)
        {
            bool isSuccess = false;
            XmlDocument xmldocument = new XmlDocument();
            xmldocument.Load(xmlFileName);
        ...
        /// <returns></returns>
        public bool DeleteOneAttribute(string xmlFileName, string xPath, string attributeName)
        {
            bool isSuccess = false;
            XmlDocument xmldocument = new XmlDocument();
            xmldocument.Load(xmlFileName);
        ...
        /// <returns></returns>
        public bool AddAttribute(string xmlFileName, string xPath, string attributeName, string value)
        {
            bool isSuccess = false;
            XmlDocument xmldocument = new XmlDocument();
            xmldocument.Load(xmlFileName);
        ...
        public bool AddNode(string xmlFileName, string xPath, string nodeName, string innerText)
        {
            bool isSuccess = false;
            ...
            try
            {
                XmlNode root = xmldocument.SelectSingleNode(xPath + "/" + nodeName);
                XmlNode xmlnode = xmldocument.SelectSingleNode(xPath);
                if (root != null)
                {
                    isExisitNode = true;
        ...
        /// <returns></returns>
        public bool UpdateNode(string xmlFileName, string xPath, string nodeName, string innerText)
        {
            bool isSuccess = false;
            bool isExisitNode = false;
            XmlDocument xmldocument = new XmlDocument();
            xmldocument.Load(xmlFileName);
            XmlNode xmlnode = xmldocument.SelectSingleNode(xPath+"/"+nodeName);
            try
            {
                if (xmlnode == null)
                {
        ...
        /// <param name="nodeName"></param>
        /// <returns></returns>
        public bool deleteNode(string xmlFileName, string xPath, string nodeName)
        {
            bool isSuccess = false;
            XmlDocument xmldocument = new XmlDocument();
            xmldocument.Load(xmlFileName);
        ...
        /// <param name="innerText"></param>
        /// <returns></returns>
        public bool UpdateChildNode(string xmlFileName, string xPath, string nodeName, string childName, string innerText)
        {
            bool isSuccess = false;
            XmlDocument xmldocument = new XmlDocument();
            xmldocument.Load(xmlFileName);
